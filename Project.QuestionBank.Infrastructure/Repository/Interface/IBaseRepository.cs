...
namespace Project.QuestionBank.Infrastructure.Repository.Interface
{
    /// <summary>
    /// 数据仓储基接口
    /// </summary>
    ...
    public interface IBaseRepository<TEntity> where TEntity : class, new()
    {
        ...
        /// <param name="strOrderByFileds">排序字段，如name asc,age desc</param>
        /// <returns>实体集合List<TEntity></returns>
        Task<List<TEntity>> QueryPageDefault(Expression<Func<TEntity, bool>> whereExpression, int intPageIndex = 0, int intPageSize = 20, string strOrderByFileds = null);
